...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/11/2024 às 22:33
...
(9, 'isabela', 'teste- alterando', '12.312.312/3123-12', '123.456.789.123', 'alterando', 'Jd. Terezaaaa', '-', '2', 7, 10, '(32) 78382-321', '(32) 78382-321', 'q', 'N', 'isa@gmail.com');
...
INSERT INTO `motorista` (`id`, `nome_completo`, `cpf`, `rg`, `cnh`, `dt_nasc`, `dt_venc_cnh`, `endereco`, `bairro`, `numero`, `complemento`, `cidade`, `estado`, `telefone`, `email`, `ativo`, `chave_pix`, `observacao`) VALUES
(1, 'isabela', '430.286.618-70', '45455', '45554', '2004-04-07', '2030-02-13', 'rua teste', 'jd.3', '2', '-', 1, 25, '18', 'isabelaovc95@gmail.com', 'S', '455', '-');
...
INSERT INTO `peca` (`descricao`, `id`) VALUES
('vela', 1);
...
INSERT INTO `produto` (`id`, `id_categoria`, `marca`, `descricao`, `observacao`, `estoque`, `preco`, `unidade`, `validade`, `ativo`, `usuario`, `ncm`, `cfop`, `pis`, `cofins`, `icms_cst`, `aliquota_pis`, `aliquota_cofins`, `aliquota_icms`, `ipi`, `aliquota_reducao_bc`, `origem_icms`, `cest`, `gtin`, `aliquota_mva`, `codigo_barras`) VALUES
(3, 1, NULL, 'vela', NULL, 0.00, 45.00, NULL, NULL, 'S', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL);
