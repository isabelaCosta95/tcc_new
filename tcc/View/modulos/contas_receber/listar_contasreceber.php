...
<head>
    ...
    <title>Movimentação Contas a Receber</title>
    <style>
        table {
            width: 100%;
    ...
    <div class="container">
        ...
        <main>
            <div class="titulo-pagina">
                <h2>Movimentação Contas a Receber</h2>
            </div>
            ...
            <form method="GET" action="/tcc/contasReceber">
                ...
                <tbody>
                    <?php for ($i = 0; $i < $total_rec; $i++): ?>
                        <tr>
                            ...
                            <td><?= !empty($lista_rec[$i]->dt_pagamento) ? (new DateTime($lista_rec[$i]->dt_pagamento))->format('d/m/Y') : '' ?></td>
                            <td><?= !empty($lista_rec[$i]->dt_vencimento) ? (new DateTime($lista_rec[$i]->dt_vencimento))->format('d/m/Y') : '' ?></td>
